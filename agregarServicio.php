...
<body>
    ...
    <div class="container2 cuerpoCard col-md-12 justify-content-center">
        <div class="forms1 justify-content-center">
            ...
            <form class="row col-sm-12 elform ft" id="elform" action="back/servicioCtrl.php">
                <input type="text" name="opcion" value="insertar" hidden>

                <div class="form-group col-sm-6 mb-5 pb-5">
                    <label for="">Nombre del servicio</label>
                    <input type="text" class="form-control" id="" aria-describedby="emailHelp" placeholder="Nombre del servicio" name="nombreServicio" required>
                </div>
                <div class="form-group col-sm-6 mb-5 pb-5">
                    <label for="">Costo Inicial</label>
                    <input type="number" class="form-control" id="" name="costoInicial" placeholder="Costo inicial" required>
                </div>


                <div class="form-group mt-1 pt-1 col-sm-6 mb-5 pb-5">
                    <label for="">Tipo de servicio</label>
                    <input type="text" class="form-control" id="" name="idTipoServicio" placeholder="Tipo de servicio" required>
                </div>
                ...
                <div class="form-group  col-md-12 mt-1 pt-1  col-sm-6 mb-5 pb-5">
                    ...
                    <input type="text" class="form-control" id="" name="urlVideo" placeholder="URL del servicio" required>
                </div>


                <div class="form-group col-md-12 mt-1 pt-1 mb-5 pb-5">
                    <label for="">Presentacion del servicio</label>
                    <input type="text" class="form-control" id="" name="presentacionServicio" placeholder="Presentacion de servicio" required>
                </div>

                <div class="form-group col-md-12 mt-1 pt-1 mb-5 pb-5">
                    <label for="">Descripcion de servicio</label>
                    <input type="text" class="form-control" id="" name="descripcionServicio" placeholder="Descripcion de servicio" rows="6" required>
                </div>
