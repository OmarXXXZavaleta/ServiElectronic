            ...
            <table id="example" class="table table-striped table-bordered ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>mau@gmail.com</td>
                        <td>Activo</td>
                        <td class="ab"><i class="fa fa-trash fa-2x" data-title="Eliminar usuario" data-toggle="modal" data-target="#exampleModalCenter"></i>
                            <i class="fa fa-pencil fa-2x" aria-hidden="true" data-title="Editar usuario" onclick="location.href='actualizarUsuario.php';"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="location.href='listadoUsuarios.php';">Aceptar</button>
            </div>
        </div>
    </div>
</div>
