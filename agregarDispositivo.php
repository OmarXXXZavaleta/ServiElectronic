        ...
        <div class="forms1 fmr1 justify-content-center">
            <div class="update upd mb-3">
                ...
                <p class="indicaciones">
                    Formulario para ingresar un nuevo dispositivo
                </p>

            </div>
            <form class="row col-sm-12 elform efmr1" id="elform" method="post" action="back/dispositivoCtrl.php">
                <input type="text" name="opcion" value="insertar" hidden>
                <div class="form-group col-sm-6 mb-5 pb-5">
                    <label for="exampleInputEmail1">Nombre dispositivo</label>
                    <input type="text" class="form-control" name="nombreDispositivo" aria-describedby="emailHelp" placeholder="Ingrese el nombre del dispositivo" required>
                </div>
                <div class="form-group col-sm-6 mb-5 pb-5">
                    <label for="exampleInputPassword1">Modelo de dispositivo</label>
                    <input type="number" class="form-control" name="modeloDispositivo" placeholder="Ingrese el modelo de dispositivo" required>
                </div>
                <!-- <div class="form-group col-sm-6 mb-5 pb-5">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1">
                        <option name>Activo</option>
                        <option id ="">Inactivo</option>
                    </select>
                </div> -->


                <button type="submit" class="btn btn-primary btns1 col-md-12 mb-4 pb-4 baba11 " data-toggle="modal" data-target="#exampleModalCenter">Agregar
                </button>
                <!-- <button type="button" class="btn btn-primary btns1 col-md-12 mb-4 pb-4 baba11 " data-toggle="modal"
                    data-target="#exampleModalCenter">Agregar
                </button> -->
                <button type="button" class="btn bg-warning  btns2 col-md-12 babu bubu22 mensaje" id="btns2">Cancelar </button>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Esta seguro de agregar el dispositivo?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="can" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" onclick="location.href='listadoDispositivos.php';">Agregar</button>
            </div>
        </div>
    </div>
</div> -->
