            ...
            <table id="example" class="table table-striped table-bordered ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Celulares</td>
                        <td>pepe@mdo.com</td>
                        <td class="ab"><i class="fa fa-trash fa-2x" data-title="Eliminar tecnico" data-toggle="modal" data-target="#exampleModalCenter"></i>
                            <i class="fa fa-pencil fa-2x" aria-hidden="true" data-title="Editar tecnico" onclick="location.href='actualizarTecnicos.php';"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
            <div class="agregar">
                <i class="fa fa-plus-circle fa-3x" aria-hidden="true" data-title="Agregar tecnico" onclick="location.href='agregarTecnico.php';"></i>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="location.href='listadoTecnicos.php';">Aceptar</button>
            </div>
        </div>
    </div>
</div>
