        ...
        <div class="forms1 justify-content-center">
            <div class="update mb-3">
                ...
                <p class="indicaciones">
                    ...
                    Solo podras modificar la contraseña del usuario cuando el sistema emita la petición
                </p>

            </div>
            <form class="row col-sm-12 elform fru" id="elform">
                <div class="form-group fg col-sm-6 mb-5 pb-5">
                    <label for="exampleInputEmail1" class="labe">Contraseña</label>
                    <input required minlength="8" type="password" class="form-control cn" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Contaseña" disabled>
                </div>
                <button type="button" class="btn btn-primary btns1 col-md-12  busario btUsers" id="bt1a" data-toggle="modal" data-target="#exampleModalCenter">Actualizar
                </button>
                <button type="button" class="btn bg-warning  btns2 d2 col-md-12 mensaje busario2" id="btns2">Cancelar </button>

            </form>
        </div>
    </div>

    <div class="col-sm-12 footerr ftuser bg-dark text-white justify-content-center">
        <footer class="abajo">
            <p>
